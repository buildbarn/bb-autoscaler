...
type NodeGroupConfiguration struct {
	...
	WorkersPerCapacityUnit int64                         `protobuf:"varint,4,opt,name=workers_per_capacity_unit,json=workersPerCapacityUnit,proto3" json:"workers_per_capacity_unit,omitempty"`
}
...
func (x *NodeGroupConfiguration) GetWorkersPerCapacityUnit() int64 {
	if x != nil {
...
var file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x16, 0x77, 0x6f, 0x72, 0x6b, 0x65, 0x72,
