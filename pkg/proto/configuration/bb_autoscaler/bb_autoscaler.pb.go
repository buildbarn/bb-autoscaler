...
type KubernetesReplicaSetConfiguration struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *KubernetesReplicaSetConfiguration) Reset() {
	*x = KubernetesReplicaSetConfiguration{}
	if protoimpl.UnsafeEnabled {
...
func (x *KubernetesReplicaSetConfiguration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KubernetesReplicaSetConfiguration) ProtoMessage() {}

func (x *KubernetesReplicaSetConfiguration) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KubernetesReplicaSetConfiguration.ProtoReflect.Descriptor instead.
func (*KubernetesReplicaSetConfiguration) Descriptor() ([]byte, []int) {
	return file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescGZIP(), []int{2}
}

func (x *KubernetesReplicaSetConfiguration) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *KubernetesReplicaSetConfiguration) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *KubernetesReplicaSetConfiguration) GetMinimumReplicas() int32 {
	if x != nil {
...
func (x *KubernetesReplicaSetConfiguration) GetMaximumReplicas() int32 {
	if x != nil {
...
type NodeGroupConfiguration struct {
	...
	//	*NodeGroupConfiguration_KubernetesStatefulSet
...
func (x *NodeGroupConfiguration) GetKubernetesDeployment() *KubernetesReplicaSetConfiguration {
...
func (x *NodeGroupConfiguration) GetKubernetesStatefulSet() *KubernetesReplicaSetConfiguration {
	if x, ok := x.GetKind().(*NodeGroupConfiguration_KubernetesStatefulSet); ok {
		return x.KubernetesStatefulSet
	}
	return nil
}
...
type NodeGroupConfiguration_KubernetesDeployment struct {
	KubernetesDeployment *KubernetesReplicaSetConfiguration `protobuf:"bytes,7,opt,name=kubernetes_deployment,json=kubernetesDeployment,proto3,oneof"`
}

type NodeGroupConfiguration_KubernetesStatefulSet struct {
	KubernetesStatefulSet *KubernetesReplicaSetConfiguration `protobuf:"bytes,9,opt,name=kubernetes_stateful_set,json=kubernetesStatefulSet,proto3,oneof"`
}
...
func (*NodeGroupConfiguration_KubernetesStatefulSet) isNodeGroupConfiguration_Kind() {}
...
var file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc = []byte{
	...
	0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63,
	0x61, 0x53, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x6d, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x73, 0x22, 0xb2, 0x05, 0x0a, 0x16, 0x4e, 0x6f,
	...
	0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x53, 0x65,
	...
	,
}
...
var file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_goTypes = []interface{}{
	...
	(*KubernetesReplicaSetConfiguration)(nil), // 2: buildbarn.configuration.bb_autoscaler.KubernetesReplicaSetConfiguration
...
var file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_depIdxs = []int32{
	...
	2, // 5: buildbarn.configuration.bb_autoscaler.NodeGroupConfiguration.kubernetes_deployment:type_name -> buildbarn.configuration.bb_autoscaler.KubernetesReplicaSetConfiguration
	2, // 6: buildbarn.configuration.bb_autoscaler.NodeGroupConfiguration.kubernetes_stateful_set:type_name -> buildbarn.configuration.bb_autoscaler.KubernetesReplicaSetConfiguration
...
func file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KubernetesReplicaSetConfiguration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*NodeGroupConfiguration_KubernetesStatefulSet)(nil),
	}
	type x struct{}
