...
const file_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc = "" +
	"\n" +
	"9pkg/proto/configuration/bb_autoscaler/bb_autoscaler.proto\x12%buildbarn.configuration.bb_autoscaler\x1a6build/bazel/remote/execution/v2/remote_execution.proto\x1a+pkg/proto/configuration/cloud/aws/aws.proto\x1a0pkg/proto/configuration/http/client/client.proto\"\x9a\x03\n" +
