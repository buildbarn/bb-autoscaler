...
// 	protoc        v6.31.1
// source: github.com/buildbarn/bb-autoscaler/pkg/proto/configuration/bb_autoscaler/bb_autoscaler.proto
...
func (x *ApplicationConfiguration) Reset() {
	*x = ApplicationConfiguration{}
	mi := &file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[0]
...
func (*ApplicationConfiguration) Descriptor() ([]byte, []int) {
	return file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescGZIP(), []int{0}
}

func (x *ApplicationConfiguration) GetPrometheusHttpClient() *client.Configuration {
	if x != nil {
...
func (x *EKSManagedNodeGroupConfiguration) Reset() {
	*x = EKSManagedNodeGroupConfiguration{}
	mi := &file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EKSManagedNodeGroupConfiguration) Descriptor() ([]byte, []int) {
	return file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescGZIP(), []int{1}
}
...
func (x *KubernetesDeploymentConfiguration) Reset() {
	*x = KubernetesDeploymentConfiguration{}
	mi := &file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubernetesDeploymentConfiguration) Descriptor() ([]byte, []int) {
	return file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescGZIP(), []int{2}
}
...
func (x *NodeGroupConfiguration) Reset() {
	*x = NodeGroupConfiguration{}
	mi := &file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeGroupConfiguration) Descriptor() ([]byte, []int) {
	return file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescGZIP(), []int{3}
}
...
var File_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto protoreflect.FileDescriptor
...
var (
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescOnce sync.Once
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescData []byte
)

func file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescGZIP() []byte {
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescOnce.Do(func() {
		file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc), len(file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc)))
	})
	return file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDescData
}

var file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_goTypes = []any{
...
var file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_depIdxs = []int32{
	4, // 0: buildbarn.configuration.bb_autoscaler.ApplicationConfiguration.prometheus_http_client:type_name -> buildbarn.configuration.http.client.Configuration
...
func init() {
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_init()
}
func file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_init() {
	if File_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto != nil {
		return
	}
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc), len(file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_goTypes,
		DependencyIndexes: file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_depIdxs,
		MessageInfos:      file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_msgTypes,
	}.Build()
	File_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto = out.File
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_goTypes = nil
	file_github_com_buildbarn_bb_autoscaler_pkg_proto_configuration_bb_autoscaler_bb_autoscaler_proto_depIdxs = nil
}
